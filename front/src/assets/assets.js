...
export const rooms = [
  {
    ...
    name: "Зал 1 - стандарт",
    rows: [
      { rowNumber: 1, offset: 0, seats: Array.from({length:10}, (_,i)=>({number:i+1,type:"standard"})) },
      { rowNumber: 2, offset: 0, seats: Array.from({length:10}, (_,i)=>({number:i+1,type:"standard"})) },
      { rowNumber: 3, offset: 0, seats: Array.from({length:10}, (_,i)=>({number:i+1,type:"standard"})) },
      { rowNumber: 4, offset: 0, seats: Array.from({length:10}, (_,i)=>({number:i+1,type:"standard"})) },
      { rowNumber: 5, offset: 0, seats: Array.from({length:10}, (_,i)=>({number:i+1,type:"standard"})) },
      { rowNumber: 6, offset: 0, seats: Array.from({length:10}, (_,i)=>({number:i+1,type:"standard"})) },
      { rowNumber: 7, offset: 0, seats: Array.from({length:10}, (_,i)=>({number:i+1,type:"standard"})) },
      { rowNumber: 8, offset: 0, seats: Array.from({length:10}, (_,i)=>({number:i+1,type:"standard"})) },
      { rowNumber: 9, offset: 0, seats: Array.from({length:10}, (_,i)=>({number:i+1,type:"standard"})) },
      { rowNumber: 10, offset: 0, seats: Array.from({length:10}, (_,i)=>({number:i+1,type:"standard"})) },
      { rowNumber: 11, offset: 0, seats: Array.from({length:10}, (_,i)=>({number:i+1,type:"standard"})) },
      { rowNumber: 12, offset: 0, seats: Array.from({length:10}, (_,i)=>({number:i+1,type:"standard"})) },
      { rowNumber: 13, offset: 0, seats: Array.from({length:10}, (_,i)=>({number:i+1,type:"standard"})) },
      { rowNumber: 14, offset: 0, seats: Array.from({length:10}, (_,i)=>({number:i+1,type:"standard"})) },
      { rowNumber: 15, offset: 0, seats: Array.from({length:10}, (_,i)=>({number:i+1,type:"standard"})) },
    ]
  },

  {
    _id: "room_2",
    cinema_id: "c000001",
    name: "Зал 2 - зі зсувами",
    rows: [
      { rowNumber: 1, offset: 0.5, seats: Array.from({length:19}, (_,i)=>({number:i+1,type:"standard"})) },
      { rowNumber: 2, offset: 0, seats: Array.from({length:20}, (_,i)=>({number:i+1,type:"standard"})) },
      { rowNumber: 3, offset: 0.5, seats: Array.from({length:19}, (_,i)=>({number:i+1,type:"standard"})) },
      { rowNumber: 4, offset: 0, seats: Array.from({length:20}, (_,i)=>({number:i+1,type:"standard"})) },
      { rowNumber: 5, offset: 0.5, seats: Array.from({length:19}, (_,i)=>({number:i+1,type:"standard"})) },
      { rowNumber: 6, offset: 0, seats: Array.from({length:20}, (_,i)=>({number:i+1,type:"standard"})) },
      { rowNumber: 7, offset: 0.5, seats: Array.from({length:19}, (_,i)=>({number:i+1,type:"standard"})) },
      { rowNumber: 8, offset: 0, seats: Array.from({length:20}, (_,i)=>({number:i+1,type:"standard"})) },
      { rowNumber: 9, offset: 0.5, seats: Array.from({length:19}, (_,i)=>({number:i+1,type:"standard"})) },
      { rowNumber: 10, offset: 0, seats: Array.from({length:20}, (_,i)=>({number:i+1,type:"standard"})) },
      { rowNumber: 11, offset: 0.5, seats: Array.from({length:19}, (_,i)=>({number:i+1,type:"standard"})) },
      { rowNumber: 12, offset: 0, seats: Array.from({length:20}, (_,i)=>({number:i+1,type:"standard"})) },
      { rowNumber: 13, offset: 0.5, seats: Array.from({length:19}, (_,i)=>({number:i+1,type:"standard"})) },
      { rowNumber: 14, offset: 0, seats: Array.from({length:20}, (_,i)=>({number:i+1,type:"standard"})) },
      { rowNumber: 15, offset: 0.5, seats: Array.from({length:19}, (_,i)=>({number:i+1,type:"standard"})) },
      { rowNumber: 16, offset: 0, seats: Array.from({length:20}, (_,i)=>({number:i+1,type:"standard"})) },
      { rowNumber: 17, offset: 0.5, seats: Array.from({length:19}, (_,i)=>({number:i+1,type:"standard"})) },
      { rowNumber: 18, offset: 0, seats: Array.from({length:20}, (_,i)=>({number:i+1,type:"standard"})) },
      { rowNumber: 19, offset: 0.5, seats: Array.from({length:19}, (_,i)=>({number:i+1,type:"standard"})) },
      { rowNumber: 20, offset: 0, seats: Array.from({length:20}, (_,i)=>({number:i+1,type:"standard"})) },
    ]
  },
    ...
    rows: [
      ...
      },
      {
        ...
        seats: [
          ...
          { number: 15, type: "standard" },
          { number: 16, type: "standard" },
        ],
      },
      {
        rowNumber: 6,
...
const generateSeats = (room) => {
  ...
  room.rows.forEach((row, rowIndex) => {
    row.seats.forEach((seat, seatIndex) => {
      ...
      const isAvailable = (rowIndex + seatIndex) % 5 !== 0;
