...
const SessionCard = ({ film, formatDate }) => {
  ...
  const grouped = groupByDate(film.sessions);

  const getEmbedURL = (url) => url.replace("watch?v=", "embed/") + "?autoplay=1";
      ...
      <div className="flex flex-col w-full">
        ...
        <div className="flex items-center gap-3 text-left">
          ...
          {film.trailerURL && (
            ...
            >
              <div className="bg-cta text-white rounded-full p-2 shadow-md 
        ...
        <p className="text-sm text-gray-500 mt-1">{film.category.join(", ")}</p>
